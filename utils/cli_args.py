...
def add_rsl_rl_args(parser: argparse.ArgumentParser):
    ...
    # ARGUMENTS FOR OPTUNA
    arg_group.add_argument("--learning_rate", type=float, default=None)
    arg_group.add_argument("--entropy_coef", type=float, default=None)
    arg_group.add_argument("--num_steps_per_env", type=int, default=None)
    arg_group.add_argument("--actor_hidden_dims", type=int, nargs='+', default=None)
    arg_group.add_argument("--critic_hidden_dims", type=int, nargs='+', default=None)
    arg_group.add_argument("--num_learning_epochs", type=int, default=None)
    arg_group.add_argument("--num_mini_batches", type=int, default=None)
    arg_group.add_argument("--gamma", type=float, default=None)
    arg_group.add_argument("--lam", type=float, default=None)
    arg_group.add_argument("--clip_param", type=float, default=None)
...
def update_rsl_rl_cfg(agent_cfg: RslRlOnPolicyRunnerCfg, args_cli: argparse.Namespace):
    ...
    if getattr(args_cli, "actor_hidden_dims", None) is not None:
        agent_cfg.policy.actor_hidden_dims = args_cli.actor_hidden_dims
    if getattr(args_cli, "critic_hidden_dims", None) is not None:
    ...
    if args_cli.lam is not None:
        agent_cfg.algorithm.lam = args_cli.lam
